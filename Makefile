...
CFLAGS  = -g -fmessage-length=0 -c -Wextra -pedantic -Wredundant-decls -Wdisabled-optimization -Wctor-dtor-privacy -Wnon-virtual-dtor -Woverloaded-virtual -Wsign-promo -Wold-style-cast -Werror=return-type -DLINUX -std=c++11 -Ofast  $(LLIBFLAGS) $(LDFLAGS) $(LINKFLAGS) 
